...
{
	if($page%2 == 1) $type='- impair - droite';
	else $type='- pair - gauche';
	return $type;
}
...
// print_r($stack);
	...
	if($value[0]=='') $Book.='<br><a class="sommaire" ng-click="show_page('.$page.')">'.strtoupper($cat).' ...... PAGE '.$value[1].'</a><br>'."\n";
	else $Book.='<a class="sommaire" ng-click="show_page('.$page.')">'.ucfirst($value[0]).' ...... PAGE '.$value[1].'</a><br>'."\n";
