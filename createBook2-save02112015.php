...
$Book1.='	<div>
	...
	<section class="corps">';
			...
			$Book1.='            <div class="cadre '.$typeAffiche.'">
              ...
              <div class="infoPdt">'.$listePDT['textecourt'].'</div>
...
// print_r($stack);
	...
	//key
	// $Book.='<br><a class="sommaire" ng-click="show_page('.$value[0][1].')">'.strtoupper($key).' ...... PAGE '.$value[0][1].'</a><br>'."\n";
	...
	if($value[1]%2==1) $page=$value[1]+1;
		...
		if($value[0]=='')
		{
			$Book.='<br><a class="sommaire" ng-click="show_page('.$page.')">'.strtoupper($cat).' ...... PAGE '.$value[1].'</a><br>'."\n";
			//sous sommaire
			$sommaireSousCat['SOUSSOMMAIRE '.strtoupper($cat)]='';
		}
		else
		{
			$Book.='<a class="sommaire" ng-click="show_page('.$page.')">'.ucfirst($value[0]).' ...... PAGE '.$value[1].'</a><br>'."\n";
			
			//sous sommaire
			$sommaireSousCat['SOUSSOMMAIRE '.strtoupper($cat)].='<a class="sommaire" ng-click="show_page('.$page.')">'.ucfirst($value[0]).' ...... PAGE '.$value[1].'</a><br>'."\n";
		}
